                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="category" name="category" class="form-control @error('category') is-invalid @enderror" required>
                            ...
                            <option value="Nước hoa nam" {{ old('category') == 'Nước hoa nam' ? 'selected' : '' }}>Nước hoa nam</option>
                            <option value="Nước hoa nữ" {{ old('category') == 'Nước hoa nữ' ? 'selected' : '' }}>Nước hoa nữ</option>
                            <option value="Nước hoa unisex" {{ old('category') == 'Nước hoa unisex' ? 'selected' : '' }}>Nước hoa unisex</option>
                            <option value="Nước hoa trẻ em" {{ old('category') == 'Nước hoa trẻ em' ? 'selected' : '' }}>Nước hoa trẻ em</option>
                        </select>
                        @error('category')
                            <div style="color: #dc3545; font-size: 12px; margin-top: 4px;">{{ $message }}</div>
                        @enderror
