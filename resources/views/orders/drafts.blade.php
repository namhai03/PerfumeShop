                        ...
                        <tr>
                            <td colspan="6" style="text-align: center; padding: 40px; color: #6c757d;">
                                <div style="margin-bottom: 16px;">
                                    <i class="fas fa-file-alt" style="font-size: 32px; color: #dee2e6;"></i>
                                </div>
                                <div style="font-size: 16px; font-weight: 500; margin-bottom: 8px;">Chưa có đơn hàng nháp nào</div>
                                <div style="font-size: 14px;">Bắt đầu bằng cách tạo đơn hàng nháp mới.</div>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
