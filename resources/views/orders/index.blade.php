...
@section('title', 'Danh sách đơn hàng - PerfumeShop')
                            ...
                            <td colspan="7" style="text-align: center; vertical-align: middle; padding: 0; color: #6c757d;">
                                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; min-height: 300px;">
                                    <div style="margin-bottom: 16px;">
                                        <i class="fas fa-receipt" style="font-size: 48px; color: #dee2e6;"></i>
                                    </div>
                                    <div style="font-size: 18px; font-weight: 500; margin-bottom: 8px;">Chưa có đơn hàng nào</div>
                                    <div style="font-size: 14px; color: #6c757d;">Bắt đầu bằng cách tạo đơn hàng mới.</div>
                                </div>
                            </td>
                        </tr>
                    @endforelse
