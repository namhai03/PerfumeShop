...
@section('title', 'Chỉnh sửa đơn hàng - PerfumeShop')
            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" id="phone" class="form-control" 
                           value="{{ old('phone', $order->phone) }}" placeholder="Nhập số điện thoại">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="notes" id="notes" class="form-control" 
                              rows="3" placeholder="Nhập ghi chú">{{ old('notes', $order->notes) }}</textarea>
                </div>
            </div>
        </div>
                ...
                <div>
                    <div class="form-group">
                        ...
                        <input type="text" id="final_amount" class="form-control" readonly 
                               ...
                               value="{{ number_format($order->final_amount, 0, ',', '.') }}">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    // Thêm event listeners cho tất cả sản phẩm
