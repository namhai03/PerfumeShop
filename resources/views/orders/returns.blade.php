...
@section('title', 'Đơn hàng trả - PerfumeShop')

@section('content')
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <div>
            <h1 class="page-title">Đơn hàng trả</h1>
        </div>
    ...
    <form method="GET" action="{{ route('orders.returns') }}" id="filterForm">
        <div class="card">
            <div class="search-filter-section">
                ...
                <div class="filters-container" style="display: flex; gap: 12px; flex-wrap: wrap; align-items: center;">
                    ...
                    @if(request('date_from') || request('date_to') || request('search'))
                        <a href="{{ route('orders.returns') }}" class="btn btn-outline" style="font-size: 13px; padding: 8px 16px; color: #e53e3e;">
                            ...
                            <td colspan="6" style="text-align: center; vertical-align: middle; padding: 0; color: #6c757d;">
                                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%; min-height: 300px;">
                                    <div style="margin-bottom: 16px;">
                                        <i class="fas fa-undo" style="font-size: 48px; color: #dee2e6;"></i>
                                    </div>
                                    <div style="font-size: 18px; font-weight: 500; margin-bottom: 8px;">Chưa có đơn hàng trả nào</div>
                                    <div style="font-size: 14px; color: #6c757d;">Bắt đầu bằng cách tạo đơn hàng trả mới.</div>
                                </div>
                            </td>
                        </tr>
                    @endforelse
