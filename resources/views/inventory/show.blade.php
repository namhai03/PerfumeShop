        ...
        <div>
            <div class="card">
                ...
                <div style="display:flex; gap: 16px;">
                    ...
                    @endphp
                    @if($imgPath)
                        <img src="{{ $imgPath }}" alt="{{ $product->name }}" width="96" height="96" loading="lazy" decoding="async" style="width:96px; height:96px; object-fit:cover; border-radius:8px; border:1px solid #e5e7eb;" />
                    @else
